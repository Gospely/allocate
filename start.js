...
var runBash = 'docker build -t gospel_socket . && docker run -itd -p ' + port + ':3000 -p ' + sshPort + ':22 -w /root -v ' + socketResource + ':/root/.gospely/.socket --name="gospel_socket_' + name + '" gospel_socket';
